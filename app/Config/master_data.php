...
return [
    ...
    'lead-types' => [
        ...
        'label' => 'Tipe Lead',
        'singular' => 'Tipe Lead',
        'description' => 'Segmen customer (Industrial, Commercial, Residential). Bebas dikelola.',
        'has_color' => false,
        'icon' => 'bi-building',
    ],
    'lead-systems' => [
        ...
        'label' => 'Sistem',
        'singular' => 'Sistem',
        'description' => 'Jenis sistem instalasi (On-Grid, Off-Grid, Hybrid). Bebas dikelola.',
        'has_color' => false,
        'icon' => 'bi-plug',
    ],
    'funding-sources' => [
        ...
        'singular' => 'Sumber Pendanaan',
        'description' => 'Sumber pendanaan proyek (HME, Hijau, Modena, Iforte). Bebas dikelola.',
        'has_color' => false,
        'icon' => 'bi-cash-coin',
    ],
    'need-types' => [
