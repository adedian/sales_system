...
<div class="row g-3">
    <div class="col-12 col-lg-8">
        ...
        <div class="card card-elevated mt-3">
            ...
            <div class="card-body">
                <?php if ($canOperate): ?>
                <form method="POST" action="<?= url('/procurement/' . $pr['id'] . '/items') ?>" class="row g-2 mb-4" id="procurementItemForm">
                    <?= csrf_field() ?>
                    <?php if (!empty($products)): ?>
                    <div class="col-12">
                        <label class="form-label">Pilih dari Katalog Produk (opsional)</label>
                        <select class="form-select form-select-sm" id="procurementProductPicker">
...
(function () {
    var picker = document.getElementById('procurementProductPicker');
    var form = document.getElementById('procurementItemForm');
